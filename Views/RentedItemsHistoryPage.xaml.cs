...
namespace LibraryProject.Views
{
    ...
    /// </summary>
    public sealed partial class RentedItemsHistoryPage : Page
    {
        public RentedItemsHistoryPage()
        {
            ...
            RentHistory rentHistory = libraryService.DateOfRent(LibraryService.Currentitem, UserService.ManagedAccount.Id);
