...
namespace LibraryProject.Views
{
    ...
    /// </summary>
    public sealed partial class MemberLibraryHallPage : Page
    {
        ...
        public MemberLibraryHallPage()
        {
            this.InitializeComponent();
            LibraryService libraryService = new LibraryService();
            foreach (Book item in libraryService.GetAllFreeBooks())
            {
                if (item != null)
                {
                    Books.Add(item);  
            ...
            foreach (Journal item in libraryService.GetAllFreeJournals())
            {
                if (item != null)
                {
                    Journals.Add(item);
        ...
        private void myItem_Tapped(object sender, TappedRoutedEventArgs e)
        {
            ...
            if (Text.DataContext is Book)
            {
                ...
                this.Frame.Navigate(typeof(ItemDetailsPage));
            }
