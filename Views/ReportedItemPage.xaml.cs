...
namespace LibraryProject.Views
{
    ...
    /// </summary>
    public sealed partial class ReportedItemPage : Page
    {
        public ReportedItemPage()
        {
            ...
            RentHistory rentHistory = LibraryService.Currentitem.ItemHistory.Last();
            DateTime dateTime = LibraryService.Currentitem.ItemHistory.Last().RentDay;
            RentDateField.Visibility = Visibility.Visible;
            LastRentDateField.Visibility = Visibility.Visible;
            ...
            LastRentDateField.Text = LibraryService.Currentitem.ItemHistory.Last().RentDay.AddDays(LibraryService.Currentitem.DaysUntilReturn).ToString();
            ...
            UserName.Text = userService.GetUserById(LibraryService.Currentitem.ItemHistory.Last().UserId).Username;
        }
